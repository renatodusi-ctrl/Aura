...
const sources = readSources({
  ...
  sessionMemory: "server/sessionMemory.js",
...
function collectEvidence(text, report) {
  ...
  return {
    ...
    preferenceMemory: hasEvery(text.sessionMemory, ["rememberPreference", "recentPreference", "clearsOnRestart"]) && verifyIncludes("verify-session-memory.mjs"),
